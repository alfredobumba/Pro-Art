    ...
    <main class="container mt-5">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-9 col-sm-9">
                ...
                <form name="fmCidades" method="get" action="cidadesAdm.php" onsubmit="return validaCampos()">
                ...
                <hr/>
                <h2 class="text-center">Cidades Cadastradas:</h2>
                <div class="row">
                    <?php
                        ...
                        if ($res=mysqli_query($con, $sql)) {
                            ...
                            while($reg=mysqli_fetch_assoc($res)) {
                                $nomeCidade[$i] = isset($reg['nome_cidade']) ? $reg['nome_cidade'] : '';
                                $linkCidade[$i] = isset($reg['link_cidade']) ? $reg['link_cidade'] : '';
                                $idCidade[$i] = isset($reg['id_cidade']) ? $reg['id_cidade'] : '';
